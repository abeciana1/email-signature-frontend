...
class EmailSignatureDetailsForm extends React.Component {
    ...
    render() {
        return (
            <React.Fragment>
                <Form style={{"textAlign":"left", "overflowX":"scroll", "position":"fixed", "width":"30%", "height":"60%", "marginBottom": "0px", "paddingBottom":"5%"}}>
                    <Form.Group>
                        <Form.Label style={{ "color": "#FFCD04" }}>Profile Image</Form.Label>
                        <Form.Control type="text" placeholder="Profile Image" name="profile_image" value={this.props.profile_image} onChange={this.changeHandler} style={{"width":"75%"}} />
                    </Form.Group>
                    <Form.Group>
